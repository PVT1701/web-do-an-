...
$conn = new mysqli('localhost', 'root', '', 'webdoanvat');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('Đăng nhập thành công!'); window.location.href='Trang chủ.php';</script>";
    } else {
        // Đăng nhập thất bại
...
<head>
    ...
    <link rel="stylesheet" href="styles(dndk).css">
                ...
                <div class="auth_form">
                    <div class="auth_form_container">
                        <div class="auth_form_head">
                            <h3 class="auth_form_dk">Đăng Nhập</h3>
                            <a href="dangky.html"><span class="auth_form_dn">Đăng Ký</span></a>
                        ...
                        <div class="auth_form1">
                            ...
                            <div class="auth_form_group">
                                <input type="text" name="username" class="auth_form_input" placeholder="Nhập tài khoản" required>
                            </div>
                            <div class="auth_form_group">
                                <input type="password" name="password" class="auth_form_input" placeholder="Nhập mật khẩu" required>
                            </div>
